...
//     axios
//       .get(productApiPath.getAllProducts) // Gọi API bằng axios
//       .then((response) => {
...
//         setIsLoading(false); // Đánh dấu là đã tải xong ngay cả khi có lỗi
//       });
...
//     axios
//       .get(productApiPath.getProductForRent) // Gọi API bằng axios
//       .then((response) => {
