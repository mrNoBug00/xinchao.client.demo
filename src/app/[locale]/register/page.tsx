...
const RegisterPage = () => {
  ...
  const handleRegister = async () => {
    ...
    try {
      await registerHandler({ username, password, email, phone, vnId, arc, passport, address });
      router.push('/login');
    } catch (error) {
  ...
  useEffect(() => {
    document.title = "Register | xinchao";
  }, []);
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 to-purple-900">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form
          ...
          <div className="mb-4">
            <label className="block text-gray-700">VN ID:</label>
            <input
              type="text"
              value={vnId}
          ...
          <div className="mb-4">
            <label className="block text-gray-700">ARC:</label>
            <input
              type="text"
              value={arc}
