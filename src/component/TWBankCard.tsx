...
const TWBankCard = () => {
  ...
  const t = useTranslations("BankCard");
  return (
    <StyledWrapper>
      <div className="card">
        <div className="foreground">
          <div className="credit-card-header">
            <div className="category">
              {" "}
              {t("Bank branch")}: <strong>013</strong>
            </div>
            <div className="bank">Cathay United Bank</div>
          </div>
          ...
          <div className="info-container">
            <p className="names">立慶資產管理顧問股份有限公司</p>
            <p className="serial">2620 3500 8696</p>
          </div>
        </div>
        <svg
